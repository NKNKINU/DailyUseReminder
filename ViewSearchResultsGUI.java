...
public class ViewSearchResultsGUI extends ViewTasksGUI {
	public ViewSearchResultsGUI() {
		super();
	}
	private String getTxt() {
		return SearchGUI.getSearch_txt();
	}
	protected void showAllEntries() {
        ...
        for (int i = 0; i < fileManager.getAll_tasks().size(); i++) {
            ...
            if (temp.getTitle().toLowerCase().contains(this.getTxt())) {
